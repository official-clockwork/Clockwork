...
// clang-format off
inline const PScore PAWN_MAT   = S(288,529);
inline const PScore KNIGHT_MAT = S(848,1002);
inline const PScore BISHOP_MAT = S(869,1099);
inline const PScore ROOK_MAT   = S(1287,1797);
inline const PScore QUEEN_MAT  = S(2800,3285);
inline const PScore TEMPO_VAL  = S(28,15);

inline const PScore BISHOP_PAIR_VAL  = S(54,216);
inline const PScore DOUBLED_PAWN_VAL = S(-72,-117);

inline const PScore POTENIAL_CHECKER_VAL = S(0, 0);
