...
// clang-format off
inline const PParam PAWN_MAT   = S(179, 158);
...
inline const std::array<PParam, 9> BISHOP_PAWNS = {
    S(1, -17), S(-4, -5), S(-4, -16), S(-9, -23), S(-15, -29), S(-21, -34), S(-24, -43), S(-28, -48), S(-40, -50),
};
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    ...
    S(167, 99),     S(200, 87),     S(182, 128),    S(204, 151),    S(207, 148),    S(157, 139),    S(159, 92),     S(121, 85),     //
...
inline const std::array<PParam, 64> BISHOP_PSQT = {
    ...
    S(94, 93),      S(53, 158),     S(48, 139),     S(7, 173),      S(-15, 179),    S(38, 165),     S(63, 141),     S(49, 134),     //
...
inline const std::array<PParam, 64> ROOK_PSQT = {
    S(397, 265),    S(458, 261),    S(380, 297),    S(434, 261),    S(415, 265),    S(353, 289),    S(371, 283),    S(389, 282),    //
...
inline const std::array<PParam, 64> QUEEN_PSQT = {
    ...
    S(437, 506),    S(518, 505),    S(437, 580),    S(433, 586),    S(384, 577),    S(388, 562),    S(466, 441),    S(424, 446),    //
    S(499, 426),    S(502, 480),    S(458, 531),    S(453, 569),    S(432, 573),    S(424, 521),    S(481, 423),    S(485, 365),    //
    ...
    S(452, 219),    S(494, 155),    S(497, 242),    S(512, 296),    S(494, 309),    S(497, 280),    S(463, 344),    S(466, 313),    //
...
inline const std::array<PParam, 64> KING_PSQT = {
    ...
    S(-209, -13),   S(-23, -21),    S(-105, 6),     S(-123, 5),     S(0, 0),        S(0, 0),        S(0, 0),        S(0, 0),        //
};

// Epoch duration: 8.81387s
// clang-format on
}  // namespace Clockwork
