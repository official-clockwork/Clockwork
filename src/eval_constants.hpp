...
inline const std::array<PParam, 6> DEFENDED_PASSED_PUSH = {
    S(47, -44), S(27, -1), S(12, 27), S(18, 71), S(85, 151), S(169, 271),
};
...
inline const std::array<PParam, 14> BISHOP_MOBILITY = {
    S(-140, -364), S(-67, -170), S(16, -104), S(48, -60), S(76, -27), S(95, -7), S(111, 1), S(126, 4), S(136, 11), S(144, 0), S(166, -18), S(218, -68), S(246, -87), S(307, -130),
};
inline const std::array<PParam, 15> ROOK_MOBILITY = {
    S(-201, -389), S(-115, -135), S(-59, -60), S(-22, -45), S(6, -17), S(28, 0), S(50, 8), S(79, 8), S(105, 17), S(132, 27), S(160, 26), S(176, 30), S(213, 24), S(232, 7), S(371, -116),
};
inline const std::array<PParam, 28> QUEEN_MOBILITY = {
    S(-328, 68), S(-289, -801), S(-194, -666), S(-146, -449), S(-121, -263), S(-87, -176), S(-87, -41), S(-60, -45), S(-51, -4), S(-40, 17), S(-32, 41), S(-28, 61), S(-12, 60), S(0, 61), S(4, 64), S(21, 51), S(15, 62), S(28, 44), S(51, 8), S(80, -34), S(104, -65), S(138, -134), S(192, -169), S(353, -343), S(327, -351), S(760, -589), S(549, -521), S(1242, -893),
};
inline const std::array<PParam, 9> KING_MOBILITY = {
    S(427, 564), S(141, 383), S(44, 465), S(30, 500), S(7, 494), S(-29, 494), S(-5, 488), S(-14, 470), S(-12, 400),
};
...
inline const std::array<PParam, 9> BISHOP_PAWNS = {
    S(-6, -11), S(-8, -4), S(-7, -13), S(-12, -23), S(-17, -27), S(-22, -32), S(-23, -39), S(-29, -37), S(-36, -48),
};

inline const std::array<PParam, 48> PAWN_PSQT = {
    S(193, 394),    S(213, 438),    S(253, 413),    S(316, 287),    S(240, 297),    S(240, 359),    S(152, 375),    S(192, 348),    //
    S(35, -32),     S(165, -6),     S(139, -65),    S(141, -121),   S(95, -135),    S(44, -92),     S(5, -43),      S(-57, -45),    //
    ...
    S(-49, -156),   S(17, -152),    S(-25, -112),   S(-58, -104),   S(-73, -116),   S(-115, -118),  S(-135, -103),  S(-167, -108),  //
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    ...
    S(-39, -54),    S(4, -28),      S(20, -39),     S(31, -30),     S(26, -22),     S(-20, -54),    S(-41, -37),    S(-92, -75),    //
};
inline const std::array<PParam, 64> BISHOP_PSQT = {
    S(-140, 91),    S(-148, 60),    S(-386, 86),    S(-305, 120),   S(-225, 112),   S(-413, 141),   S(-118, 111),   S(-82, 90),     //
    ...
    S(73, -23),     S(97, 19),      S(105, 45),     S(111, 65),     S(101, 87),     S(57, 74),      S(42, 29),      S(27, -28),     //
    S(89, -33),     S(137, -3),     S(145, 6),      S(79, 49),      S(63, 58),      S(58, 58),      S(90, 9),       S(58, -33),     //
    S(79, -71),     S(124, -40),    S(103, -30),    S(75, 2),       S(65, -16),     S(63, -20),     S(38, -10),     S(63, -78),     //
...
inline const std::array<PParam, 64> ROOK_PSQT = {
    ...
    S(78, 90),      S(161, 68),     S(226, 47),     S(169, 83),     S(181, 72),     S(127, 82),     S(81, 96),      S(58, 108),     //
    S(60, 69),      S(200, 35),     S(240, 19),     S(262, 10),     S(216, 22),     S(134, 62),     S(148, 52),     S(28, 105),     //
    S(15, 62),      S(85, 53),      S(122, 46),     S(163, 3),      S(131, 27),     S(61, 80),      S(40, 76),      S(-33, 88),     //
    S(-57, 21),     S(23, 27),      S(21, 37),      S(19, 35),      S(15, 28),      S(-12, 74),     S(-42, 71),     S(-64, 59),     //
    S(-84, 0),      S(-11, -27),    S(-9, -2),      S(-28, 4),      S(-5, -18),     S(-58, 32),     S(-65, 21),     S(-85, 15),     //
    S(-130, 6),     S(-39, -45),    S(-15, -33),    S(-3, -33),     S(-10, -30),    S(-29, -15),    S(-47, -35),    S(-87, -20),    //
    S(-108, 8),     S(-69, 14),     S(-23, -18),    S(9, -36),      S(0, -22),      S(-11, -16),    S(-34, -21),    S(-65, -4),     //
};
...
inline const std::array<PParam, 64> KING_PSQT = {
    ...
    S(-50, -131),   S(87, -116),    S(-1, -83),     S(-23, -75),    S(0, 0),        S(0, 0),        S(0, 0),        S(0, 0),        //
};
// clang-format on
}
