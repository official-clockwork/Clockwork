...
#define CLOCKWORK_TUNABLES(TUNE, NO_TUNE)                         \
    ...
    TUNE(nmp_beta_diff, 380, 200, 800, 38, 0.002)                 \
    TUNE(nmp_improving_r, 69, 32, 128, 5, 0.002)                  \
                                                                  \
    /* ProbCut Values */                                          \
    TUNE(probcut_margin, 337, 166, 664, 25, 0.002)                \
    TUNE(probcut_see, 106, 54, 200, 10, 0.002)                     \
    NO_TUNE(probcut_min_depth, 5, 1, 20, 0.5, 0.002)              \
                                                                  \
    /* SEE Values */                                              \
    TUNE(quiesce_see_threshold, 27, -1000, 200, 20, 0.002)        \
    TUNE(movepicker_see_capthist_divisor, 63, 16, 192, 10, 0.002) \
    TUNE(see_pawn_val, 104, 50, 200, 8, 0.002)                    \
    TUNE(see_knight_val, 311, 150, 600, 23, 0.002)                \
    TUNE(see_bishop_val, 298, 150, 600, 23, 0.002)                \
    TUNE(see_rook_val, 531, 250, 1000, 38, 0.002)                 \
    TUNE(see_queen_val, 977, 450, 1800, 68, 0.002)                \
                                                                  \
    /* Stat Bonus */                                              \
    TUNE(stat_bonus_max, 1970, 948, 3792, 142, 0.002)             \
    TUNE(stat_bonus_quad, 3, 2, 8, .5, 0.002)                     \
    TUNE(stat_bonus_lin, 110, 60, 240, 9, 0.002)                  \
    TUNE(stat_bonus_sub, 131, 60, 240, 9, 0.002)                  \
                                                                  \
    /* Stat Malus */                                              \
    TUNE(stat_malus_max, 1660, 948, 3792, 142, 0.002)             \
    TUNE(stat_malus_quad, 4, 2, 8, .5, 0.002)                     \
    TUNE(stat_malus_lin, 139, 60, 240, 9, 0.002)                  \
    TUNE(stat_malus_sub, 122, 60, 240, 9, 0.002)                  \
                                                                  \
    /* Search Params */                                           \
    ...
    NO_TUNE(lmp_depth_mult, 3, 1, 20, 0.5, 0.002)                 \
                                                                  \
    /* Futility Pruning */                                        \
    TUNE(ffp_margin_base, 470, 250, 1000, 38, 0.002)              \
    ...
    TUNE(qhp_threshold, -2091, -4096, -1024, 154, 0.002)          \
                                                                  \
    /* SEE PVS */                                                 \
    TUNE(see_pvs_quiet, -62, -134, -33, 5, 0.002)                 \
    ...
    TUNE(sing_beta_margin, 306, 160, 640, 19, 0.002)              \
    TUNE(dext_margin, 41, 20, 80, 3, 0.002)                       \
    TUNE(dext_hist_div, 519, 256, 1024, 39, 0.002)                \
    TUNE(triext_margin, 128, 60, 240, 9, 0.002)                   \
    TUNE(triext_hist_div, 528, 256, 1024, 39, 0.002)              \
                                                                  \
    /* LMR */                                                     \
    TUNE(lmr_quiet_base, 627, 394, 1576, 59, 0.002)               \
    TUNE(lmr_quiet_div, 166, 104, 416, 16, 0.002)                 \
    TUNE(lmr_noisy_base, 253, 128, 512, 20, 0.002)                \
    TUNE(lmr_noisy_div, 212, 98, 394, 15, 0.002)                  \
    TUNE(lmr_pv_node_red, 1143, 512, 2048, 77, 0.002)             \
    TUNE(lmr_alpha_raise_red, 513, 256, 1024, 38, 0.002)          \
    TUNE(lmr_not_improving_red, 512, 256, 1024, 38, 0.002)        \
    TUNE(lmr_in_check_red, 1053, 512, 2048, 77, 0.002)            \
    TUNE(lmr_cutnode_red, 1159, 512, 2048, 77, 0.002)             \
    TUNE(lmr_no_tt_red, 957, 512, 2048, 77, 0.002)                \
    TUNE(lmr_ttpv_red, 958, 512, 2048, 77, 0.002)                \
    TUNE(lmr_tt_capture_red, 1095, 512, 2048, 77, 0.002)           \
    TUNE(lmr_fail_high_red, 1005, 512, 2048, 77, 0.002)            \
    TUNE(lmr_quiet_hist_base, 988, 512, 2048, 77, 0.002)          \
    TUNE(lmr_hist_div, 14, 4, 16, 2, 0.002)                       \
    TUNE(lmr_fut_red_base, 525, 250, 1000, 38, 0.002)             \
    TUNE(lmr_fut_red_mult, 101, 50, 200, 8, 0.002)                 \
    TUNE(lmr_fut_red, 678, 512, 2048, 77, 0.002)                  \
    TUNE(lmr_max_red, 2911, 1536, 6144, 231, 0.002)               \
                                                                  \
    /* TIME MANAGEMENT */                                         \
    TUNE(time_hard_limit, 267, 128, 512, 19, 0.002)               \
    TUNE(time_soft_limit, 52, 25, 100, 3, 0.002)                  \
    TUNE(time_soft_increment, 540, 256, 1024, 38, 0.002)          \
    TUNE(nodetm_min_factor, 501, 256, 1024, 38, 0.002)            \
    TUNE(nodetm_avg_factor, 2226, 1024, 4096, 153, 0.002)         \
    TUNE(nodetm_frac_factor, 2116, 948, 3792, 142, 0.002)         \
    TUNE(d1plexity_base, 821, 394, 1576, 59, 0.002)               \
    TUNE(d1plexity_max_complexity, 212, 100, 400, 15, 0.002)      \
    TUNE(d1plexity_divisor, 394, 193, 772, 29, 0.002)             \
                                                                  \
    /* End of Tunables */
