...
struct TunableOption final : Option<ParamType> {
	...
	public:
		TunableOption(const std::string& name, ParamType default_value, ParamType min_value, ParamType max_value, ParamType c, const float r)
			: Option<ParamType>(name, default_value, min_value, max_value), c(c), r(r) {}
